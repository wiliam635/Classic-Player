...
/usr/libexec/PlistBuddy -c "Set :CFBundleShortVersionString 2.0.1" "$UNIVERSAL/Contents/Info.plist"
/usr/libexec/PlistBuddy -c "Set :CFBundleVersion 2.0.1" "$UNIVERSAL/Contents/Info.plist"
